...
/**
  * Applet_Shipainter.php ($Revision: 1.43 $)
  * for Oekaki Shi-Painter Ver1.081
  * 
  * by hsur ( http://blog.cles.jp/np_cles )
  * $Id: Applet_Shipainter.php,v 1.43 2010/06/06 11:44:19 hsur Exp $
*/
...
class Applet_Shipainter extends PaintPlugin {
	function getName(){
		return _PAINT_Applet_Shipainter_name . ' ' . _PAINT_Applet;
	}
	
	function Applet_Shipainter(){
		$this->id = '$Id: Applet_Shipainter.php,v 1.43 2010/06/06 11:44:19 hsur Exp $';
		$this->name = _PAINT_Applet_Shipainter_name;
