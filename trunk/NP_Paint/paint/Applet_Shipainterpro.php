...
/**
  * Applet_Shipainterpro.php ($Revision: 1.43 $)
  * for Oekaki Shi-Painter Ver1.081
  * 
  * by hsur ( http://blog.cles.jp/np_cles )
  * $Id: Applet_Shipainterpro.php,v 1.43 2010/06/06 11:44:19 hsur Exp $
*/
...
class Applet_Shipainterpro extends PaintPlugin {
	function getName(){
		return _PAINT_Applet_Shipainterpro_name . ' ' . _PAINT_Applet;
	}
	
	function Applet_Shipainterpro(){
		$this->id = '$Id: Applet_Shipainterpro.php,v 1.43 2010/06/06 11:44:19 hsur Exp $';
		$this->name = _PAINT_Applet_Shipainterpro_name;
