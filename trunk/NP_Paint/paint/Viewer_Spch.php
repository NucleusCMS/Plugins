...
/**
  * Viewer_Spch ($Revision: 1.14 $)
  * for pchview_115
  * 
  * by hsur ( http://blog.cles.jp/np_cles )
  * $Id: Viewer_Spch.php,v 1.14 2010/06/06 11:44:19 hsur Exp $
*/
...
class Viewer_Spch extends PaintPlugin {
	function getName(){
		return 'SPCH Viewer ' . _PAINT_Viewer_spch_desc;
	}

	function Viewer_Spch(){
		$this->id = '$Id: Viewer_Spch.php,v 1.14 2010/06/06 11:44:19 hsur Exp $';
		$this->name = 'spch viewer';
